...
class CostumCounter extends StatelessWidget {
  const CostumCounter({super.key});
              ...
              builder: (context, value, child) {
                return Row(
                  children: [
                    defContainer(
                        color: Colors.grey,
                        text: value.changableTime.hour.toString()),
                    defContainer(
                        color: Colors.grey,
                        text:value.changableTime.minute.toString()),
                    defContainer(
                        color: Colors.grey,
                        text:value.changableTime.second.toString()),
                  ],
                );
              },
            ),
