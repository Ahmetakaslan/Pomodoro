              ...
              builder: (context) {
                return SizedBox(
                  ...
                  child: CupertinoDatePicker(
                    ...
                    initialDateTime: Provider.of<TimePicker>(context).valDateTime,
                    onDateTimeChanged: (value) async {
                      Provider.of<TimePicker>(context,listen: false).fChaneDefTime(value);
                      Provider.of<TimerClass>(context, listen: false)
                          .changeDefTime(
                        Time(hour: value.hour, minute: value.minute, second: 0),
                      );
